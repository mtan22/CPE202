...
class TestHeap(unittest.TestCase):
    ...
    def test_03_peek_and_dequeue_2_item(self) -> None:
        test_heap = MinHeap(10)
        test_heap.enqueue(-34)
        self.assertEqual(test_heap.peek(), -34)
        self.assertEqual(test_heap.dequeue(), -34)
    ...
    def test_13_build_heap2(self) -> None:
        test_heap = MinHeap(8)
        test_heap.build_heap([-3, -5, -2, -6, 9])
        self.assertEqual(test_heap.contents(), [-6, -5, -2, -3, 9])

    def test_14_build_heap3(self) -> None:
        test_heap_1 = MinHeap()
        test_heap_1.build_heap([3, 4, 5, 6, 7, 10, 8, 1, 2])
        test_heap_2 = MinHeap()
        self.assertEqual(test_heap_1.contents(), [1, 2, 5, 3, 7, 10, 8, 6, 4])
        self.assertEqual(test_heap_2.contents(), [])
    ...
    def test_21_heap_sort_increase2(self) -> None:
        test_heap = MinHeap()
        list1 = [-3, 5, 3, -9, -10]
        test_heap.heap_sort_ascending(list1)
        self.assertEqual(list1, [-10, -9, -3, 3, 5])
