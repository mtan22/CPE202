...
''' Add later if timing tests can be done and spec is clarified:
        Check that pop, peek, is_empty, is_full are O(1)
        Check that push and size are O(1) for array-based version
...
class TestLab2(unittest.TestCase):
    ...
    def test_stack_pushPopCombo_with_strings_and_floats(self) -> None:
        s = Stack(11)
        s.push('stuff')
        ...
        self.assertEqual(93, s.peek())


        self.assertEqual(93, s.pop())
        self.assertEqual(10, s.size())
